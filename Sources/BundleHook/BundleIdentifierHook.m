// From alerter (https://github.com/vjeantet/alerter), MIT License.
// Swizzles NSBundle so notifications are attributed to another app's
// bundle identifier (its icon, its notification permission).
